...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MessageViewHolder> {
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder {
                    ...
                    .addOnSuccessListener(documentSnapshot -> {
                        if (documentSnapshot.exists()) {
                            ...
                            if (sender != null) {
                                ...
                                bindUserData(sender);
                            } else {// If the document exists but could not be deserialized
        ...
        /**
         * Sets default user data if sender details cannot be retrieved.
         */
        private void setDefaultUserData() {
            binding.receivedNameOrPhoneOrEmail.setText("Unknown Sender");
            binding.receivedProfilePicture.setImageResource(R.drawable.ic_profile);
        }
    }
